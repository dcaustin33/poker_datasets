...
def create_combined_dataset(
    ...
    if path_to_pokerbench_preflop_train:
        ...
        preflop_narratives = convert_dataframe_to_narratives(
            df_preflop, pokerbench_preflop=True, max_workers=max_workers, instruction_tuned=instruction_tuned
        )
    ...
    if path_to_pokerbench_postflop_train:
        ...
        postflop_narratives = convert_dataframe_to_narratives(
            df_postflop, pokerbench_postflop=True, max_workers=max_workers, instruction_tuned=instruction_tuned
        )
